//! firefly-ecm-esignature-docusign — the placeholder DocuSign
//! [`ESignatureProvider`] adapter (JWT-Bearer + REST v2.1).
//!
//! Faithful port of the Go module `fireflyframework-go/ecmesignaturedocusign`:
