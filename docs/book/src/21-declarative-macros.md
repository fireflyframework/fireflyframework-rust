...
<figcaption>Declarative, compile-time. Each attribute or derive expands to the wiring you would otherwise hand-write: a <code>Message</code> impl, an OpenAPI schema, an event discriminator, a controller <code>routes()</code> builder, or a scanned bean with autowired fields — generated by <code>firefly-macros</code>, not by a codegen step you run.</figcaption>
</figure>
